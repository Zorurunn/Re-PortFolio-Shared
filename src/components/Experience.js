    ...
    const data = [
        {
            ...
            lists: [
                {
                    dot: <ActiveDotI color={props.dark ? '#D1D5DB' : 'black'} width={'6'} height={'6'} />,

                    description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.',
                },
                {
                    dot: <ActiveDotI color={props.dark ? '#D1D5DB' : 'black'} width={'6'} height={'6'} />,
                    description: 'Ut pretium arcu et massa semper, id fringilla leo semper.',
                },
                {
                    dot: <ActiveDotI color={props.dark ? '#D1D5DB' : 'black'} width={'6'} height={'6'} />,
                ...
                {
                    dot: <ActiveDotI color={props.dark ? '#D1D5DB' : 'black'} width={'6'} height={'6'} />,
                    description: 'Lorem pretium arcu et massa semper, id fringilla leo semper.',
                },
            ]
        },
        {
        ...
        },
        {
            ...
            lists: [
                {
                    dot: <ActiveDotI color={props.dark ? '#D1D5DB' : 'black'} width={'6'} height={'6'} />,
                    description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. consectetur adipiscing elit consectetur adipiscing elit',
                },
            ]
        }
    ]
