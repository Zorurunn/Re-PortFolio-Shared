      ...
      <div className={props.bg + " " + "w-screen dark:text-[#D1D5DB]"}>
        <div
          className={
            props.maxWidth +
            " " +
            "w-screen m-auto pt-[24px] pb-[24px] flex justify-center items-center"
          }
        >
          <div className="flex gap-[10px]">
            ...
            <div className="text-[12px] md:text-[24px]">
              2023 | Designed from Google coded with ❤️️ by Udval Zolzaya
            </div>
          </div>
        </div>
      </div>
